                        ...
                        <div className="relative">
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="relative pl-12">
                                    ...
                                    <h3 className="text-xl font-semibold text-white mb-2 ">Gujarat Technological University</h3>
                                    <p className="text-gray-400 text-sm mb-3 ">2020 — 2024</p>
                                    <p className="text-gray-300 leading-relaxed ">
                                        I hold a Bachelor of Technology (B.Tech) in Computer Engineering from Gujarat Technological
                                        University, where I graduated with a CGPA of 9.0. My studies provided me with a strong
                                        foundation in computer science principles and practical skills, which I apply in my work as a
                                ...
                                <div className="relative pl-12">
                                    <div className="absolute left-[13px] top-2 w-4 h-4 bg-white/30 rounded-full z-10  after:content-[''] after:absolute after:left-1/2 after:top-1/2 after:-translate-x-1/2 after:-translate-y-1/2 after:w-2 after:h-2 after:bg-green-500 after:rounded-full"></div>
                                    <h3 className="text-xl font-semibold text-white mb-2">The Imperial Science School</h3>
                                    <p className="text-gray-400 text-sm mb-3">2018 — 2020</p>
                                    <p className="text-gray-300 leading-relaxed">
                                        I completed my high schooling at The Imperial Science School, where I achieved an A+ grade.
                                        This solid academic foundation helped shape my passion for technology and set the stage
                                        for my further studies in computer engineering.
                                    </p>
                                </div>
