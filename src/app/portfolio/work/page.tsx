...
export const metadata: Metadata = {
    ...
    description: 'Explore a collection of professional and personal projects built using React, Node.js, MongoDB, and more.',
    keywords: ['Hire',
        'Hire Me',
        'Gandhinagar',
        'Ahmedabad', 'Portfolio', 'Projects', 'React', 'Node.js', 'MongoDB', 'Full Stack', 'Dushyant Solanki'],
    openGraph: {
        title: 'Dushyant Solanki - Work',
        description: 'Showcasing projects including Task Mate, Go Din Din, Zirotix, and more.',
